...
class _FinanceDashboardState extends ConsumerState<FinanceDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> statCards = [
      ...
      {
        'label': "Fees Notice Hub",
        'value': "Publish Notices",
        'icon': Icons.campaign,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (recentPayments.isEmpty)
                                  ...
                                  ...(showAllSlips
                                          ? recentPayments
                                          : recentPayments.take(3))
                                      .map((p) {
                                    return GestureDetector(
                                      onTap: () => context
                                          .push('/finance/receipt/${p['_id']}'),
                                      child: Container(
                                        margin:
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(
                                                height:
                                                    8), // Amount ke upar thoda spacing diya hai
                                            Text("₹${p['amount']}",
                                                style: const TextStyle(
                                                    fontSize: 15,
                                                    fontWeight: FontWeight.w900,
                    ...
                    const SizedBox(
                        height:
                            80), // 🔥 LOCK 120px EXTRA BOTTOM SPACE FOR NAVIGATION BAR 🔥
                  ],
                ),
              ),
            ),
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontStyle: FontStyle.italic)),
                              Text(
                                  "${newPaymentAlert!['grade']} • Received Now",
                                  style: TextStyle(
                                      fontSize: 9,
                                      fontWeight: FontWeight.w900,
                                      color: textColorSecondary)),
                      ...
                      begin: -1.0, duration: 400.ms, curve: Curves.easeOutBack))
          ],
        ),
      ),
    );
